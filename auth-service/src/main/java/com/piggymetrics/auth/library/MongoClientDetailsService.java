...
public class MongoClientDetailsService implements ClientDetailsService, ClientRegistrationService {
    ...
    public void updateClientDetails(ClientDetails clientDetails) throws NoSuchClientException {
        ...
        /*WriteResult writeResult*/ UpdateResult updateResult = mongoTemplate.updateFirst(query, update, MongoClientDetails.class);

        if(/*writeResult.getN()*/ updateResult.getModifiedCount()<= 0) {
    ...
    public void removeClientDetails(String clientId) throws NoSuchClientException {
        ...
        /*WriteResult writeResult*/ DeleteResult deleteResult = mongoTemplate.remove(query, MongoClientDetails.class);

        if(/*writeResult.getN() */deleteResult.getDeletedCount()<= 0) {
            throw new NoSuchClientException(String.format("Client with id %s not found", clientId));
        }
    }
